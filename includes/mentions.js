...
function mentionsSelect(terms, video_table) {
...
(
  ...
  ${select_context(terms, 'mentions_select_cap', 'caption', null, ['offset_seconds::int offset_seconds'])}
  union all
  ${select_context(terms, 'mentions_select_vid', 'video_title', 'title', ['null offset_seconds'])}
  union all
  ${select_context(terms, 'mentions_select_vid', 'description', null, ['null offset_seconds'])}
  union all
  (
